...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      // Shadow/Elevation Scale - DRAMATIC SHADOWS
      ...
      boxShadow: {
        ...
        xl: '0 24px 60px rgba(0, 0, 0, 0.25)',
        '2xl': '0 32px 80px rgba(0, 0, 0, 0.3)',
      },
      // Gradient System - MORE VIBRANT & PROMINENT
      // Usage: bg-gradient-rephlo, bg-gradient-rephlo-vertical, bg-gradient-navy-blue
      backgroundImage: {
        'gradient-rephlo': 'linear-gradient(135deg, #1D4ED8 0%, #0EA5E9 50%, #06B6D4 100%)',
        'gradient-rephlo-vertical': 'linear-gradient(180deg, #1D4ED8 0%, #0EA5E9 50%, #06B6D4 100%)',
        'gradient-navy-blue': 'linear-gradient(135deg, #0F172A 0%, #1E40AF 100%)',
        'gradient-vibrant': 'linear-gradient(135deg, #2563EB 0%, #3B82F6 25%, #06B6D4 75%, #22D3EE 100%)',
      },
