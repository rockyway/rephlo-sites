...
**Generated:** 2025-11-18T08:23:07.441Z
**Format:** Simple
**Include Tests:** No
...
| GET | `/api/user/credits` | `backend\src\routes\api.routes.ts L:156` | `creditsController.getDetailedCredits` | `any` | - | `authMiddleware` | - |
| GET | `/api/user/invoices` | `backend\src\routes\api.routes.ts L:196` | `billingController.getInvoices` | `GetInvoices_Response` | - | `authMiddleware` | - |
| GET | `/api/user/profile` | `backend\src\routes\api.routes.ts L:105` | `usersController.getUserProfile` | - | - | `authMiddleware` | - |
| GET | `/api/user/usage/summary` | `backend\src\routes\api.routes.ts L:251` | `usageController.getMonthlySummary` | `UsageSummaryResponse` | - | `authMiddleware` | - |
