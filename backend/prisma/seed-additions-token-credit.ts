...
export async function seedTokenCreditSystem(prisma: PrismaClient, adminUser: any) {
  ...
  // Tier-based multipliers - Updated 2025-11-15
  const pricingConfigs = [
    {
      ...
      effectiveFrom: new Date('2025-11-15T00:00:00Z'),
      effectiveUntil: null,
      reason: 'initial_setup',
      reasonDetails: 'Free tier - 2.0x multiplier = 50% margin (abuse protection)',
    ...
    },
    {
      ...
      effectiveFrom: new Date('2025-11-15T00:00:00Z'),
      effectiveUntil: null,
      reason: 'pricing_restructure',
      reasonDetails: 'Pro tier - 1.0x multiplier = break-even (volume play, entry point)',
      previousMultiplier: null,
      changePercent: null,
      expectedMarginChangeDollars: null,
      expectedRevenueImpact: null,
    ...
    },
    {
      ...
      effectiveUntil: null,
      reason: 'initial_setup',
      reasonDetails: 'Pro+ tier (NEW) - 1.1x multiplier = 10% margin (balanced)',
      previousMultiplier: null,
      changePercent: null,
      expectedMarginChangeDollars: null,
      expectedRevenueImpact: null,
    ...
    },
    {
      ...
      effectiveUntil: null,
      reason: 'pricing_restructure',
      reasonDetails: 'Pro Max tier - 1.25x multiplier = 25% margin (premium positioning)',
      previousMultiplier: null,
      changePercent: null,
      expectedMarginChangeDollars: null,
      expectedRevenueImpact: null,
    ...
    {
      scopeType: 'tier',
      subscriptionTier: SubscriptionTier.enterprise_pro,
      providerId: null,
      modelId: null,
      ...
      effectiveUntil: null,
      reason: 'initial_setup',
      reasonDetails: 'Enterprise Pro tier (COMING Q2 2026) - 1.15x multiplier = 15% margin',
      previousMultiplier: null,
      changePercent: null,
      expectedMarginChangeDollars: null,
      expectedRevenueImpact: null,
    ...
    {
      scopeType: 'tier',
      subscriptionTier: SubscriptionTier.enterprise_pro_plus,
      providerId: null,
      modelId: null,
      ...
      effectiveUntil: null,
      reason: 'initial_setup',
      reasonDetails: 'Enterprise Pro+ tier (COMING Q2 2026) - 1.20x multiplier = 20% margin',
      previousMultiplier: null,
      changePercent: null,
      expectedMarginChangeDollars: null,
      expectedRevenueImpact: null,
  ...
  for (const user of users) {
    ...
    if (!existingBalance) {
      ...
      // Updated 2025-11-15: x100 conversion rate (1 credit = $0.01)
      let initialCredits = 200; // Default free tier (was 2000 with x1000 rate)
