...
async function seedModels() {
  ...
  const models = [
    // OpenAI Models (2025)
    {
      ...
      displayName: 'GPT-4.1',
      provider: 'openai',
      description: 'Latest GPT-4 model with 1M context, exceptional coding and reasoning capabilities',
    ...
    },
    {
      ...
      provider: 'openai',
      description: 'Cost-efficient GPT-4.1 with 83% cost reduction, matches GPT-4o intelligence',
    ...
    },
    {
      ...
      displayName: 'o3-mini',
      provider: 'openai',
      description: 'Advanced reasoning model with 200K context, optimized for complex problem solving',
      capabilities: [ModelCapability.text, ModelCapability.function_calling, ModelCapability.long_context, ModelCapability.code],
      contextLength: 200000,
      maxOutputTokens: 100000,
      inputCostPerMillionTokens: 1100,
      outputCostPerMillionTokens: 4400,
    ...
    // Anthropic Models (2025)
    {
      ...
      provider: 'anthropic',
      description: 'Most capable Claude for agents, coding, and computer use with 200K context',
    ...
    },
    {
      ...
      provider: 'anthropic',
      description: 'Extended thinking mode for complex reasoning tasks with 200K context',
    ...
    },
    {
      ...
      provider: 'anthropic',
      description: 'Balanced performance and speed with vision capabilities and 200K context',
      capabilities: [ModelCapability.text, ModelCapability.vision, ModelCapability.function_calling, ModelCapability.long_context],
      contextLength: 200000,
      maxOutputTokens: 8192,
      inputCostPerMillionTokens: 3000,
    ...
    },
    {
      ...
      provider: 'anthropic',
      description: 'Fastest and most cost-efficient Claude model with vision support',
