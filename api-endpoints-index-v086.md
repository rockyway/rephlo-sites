...
**Generated:** 2025-11-17T20:14:42.772Z
**Format:** Simple
**Include Tests:** No
...
| GET | `/admin/metrics` | `backend\src\routes\admin.routes.ts L:64` | `adminController.getMetrics` | `{ status: "success", data: adminController_getMetrics_Data }` | `403: forbidden`<br>`500: error_response` | `authMiddleware, requireAdmin` | frontend\src\services\api.ts L:276 |
...
| GET | `/api/admin/tier-config` | `backend\src\routes\plan190.routes.ts L:56` | `tierConfigController.listAll` | `TierConfig[]` | `500: TIER_CONFIG_FETCH_ERROR` | `authMiddleware, requireAdmin` | - |
| GET | `/api/admin/tier-config/:tierName` | `backend\src\routes\plan190.routes.ts L:86` | `tierConfigController.getByName` | `{ success: true, data: TierConfig | null }` | `404: TIER_NOT_FOUND`<br>`500: TIER_CONFIG_FETCH_ERROR` | `authMiddleware, requireAdmin` | - |
| PATCH | `/api/admin/tier-config/:tierName/credits` | `backend\src\routes\plan190.routes.ts L:206` | `tierConfigController.updateCredits` | `TierConfig` | `401: UNAUTHORIZED`<br>`400: VALIDATION_ERROR`<br>`500: TIER_UPDATE_ERROR` | `authMiddleware, requireAdmin, auditLog` | - |
| GET | `/api/admin/tier-config/:tierName/history` | `backend\src\routes\plan190.routes.ts L:125` | `tierConfigController.getHistory` | `TierConfigHistory[]` | `500: TIER_HISTORY_FETCH_ERROR` | `authMiddleware, requireAdmin` | - |
| POST | `/api/admin/tier-config/:tierName/preview` | `backend\src\routes\plan190.routes.ts L:167` | `tierConfigController.previewUpdate` | `UpdateImpact` | `400: VALIDATION_ERROR`<br>`500: PREVIEW_ERROR` | `authMiddleware, requireAdmin` | - |
| PATCH | `/api/admin/tier-config/:tierName/price` | `backend\src\routes\plan190.routes.ts L:251` | `tierConfigController.updatePrice` | `TierConfig` | `401: UNAUTHORIZED`<br>`400: VALIDATION_ERROR`<br>`500: TIER_PRICE_UPDATE_ERROR` | `authMiddleware, requireAdmin, auditLog` | - |
...
| GET | `/health` | `backend\src\routes\index.ts L:133` | `-` | - | - | `-` | frontend\src\services\api.ts L:252 |
| GET | `/health/live` | `backend\src\routes\index.ts L:214` | `-` | - | - | `-` | - |
...
| POST | `/webhooks/stripe` | `backend\src\routes\index.ts L:279` | `subscriptionsController.handleStripeWebhook` | `{ received: true }` | `400: invalid_request`<br>`401: unauthorized`<br>`500: internal_server_error` | `-` | - |
...
- **Total Usage References:** 1374
- **Unused Endpoints:** 209
...
**Source:** `backend\src\services\user-management.service.ts` (Line 73)
...
**Source:** `backend\src\services\settings.service.ts` (Line 395)
...
**Source:** `backend\src\services\settings.service.ts` (Line 406)
...
**Source:** `backend\src\services\user-management.service.ts` (Line 79)
...
**Source:** `backend\src\services\proration.service.ts` (Line 466)
...
**Source:** `backend\src\services\proration.service.ts` (Line 709)
...
**Source:** `backend\src\services\campaign-management.service.ts` (Line 127)
...
**Source:** `backend\src\services\license-management.service.ts` (Line 683)
...
**Source:** `backend\src\services\proration.service.ts` (Line 571)
...
**Source:** `backend\src\services\billing-payments.service.ts` (Line 29)
...
**Source:** `backend\src\services\billing-payments.service.ts` (Line 727)
...
**Source:** `backend\src\services\license-management.service.ts` (Line 624)
...
**Source:** `backend\src\services\billing-payments.service.ts` (Line 769)
...
**Source:** `backend\src\services\user-management.service.ts` (Line 53)
...
**Source:** `backend\src\services\settings.service.ts` (Line 375)
...
**Source:** `shared-types\src\tier-config.types.ts` (Line 20)
...
**Source:** `shared-types\src\tier-config.types.ts` (Line 87)
...
**Source:** `shared-types\src\user.types.ts` (Line 31)
