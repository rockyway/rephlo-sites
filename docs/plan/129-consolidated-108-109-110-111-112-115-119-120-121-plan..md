...
model Subscription {
  ...
  billingInterval    String             @map("billing_interval") @db.VarChar(20) // "monthly" | "annual"
  ...
  // [Plan 110] Proration/Migration Fields
  ...
  pendingCreditCents    Int              @default(0) @map("pending_credit_cents") // From downgrades
...
model SubscriptionPlan { // [Plan 109] Defines the products
  id              String           @id @default(uuid()) @db.Uuid
  tier            SubscriptionTier
...
model PerpetualLicense { // [Plan 110]
  ...
  purchasedVersion     String        @map("purchased_version") // e.g., "1.0.0"
