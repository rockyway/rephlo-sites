...
**Generated:** 2025-11-12T21:33:59.108Z
**Format:** Simple
**Include Tests:** No
...
| POST | `/chat/completions` | `backend\src\routes\v1.routes.ts L:172` | `modelsController.chatCompletion` | `authenticate` | backend\src\routes\index.ts L:92 |
...
| GET | `/usage` | `backend\src\routes\v1.routes.ts L:259` | `creditsController.getUsageHistory` | `authenticate` | frontend\src\api\plan109.ts L:389<br>backend\src\routes\index.ts L:95<br>backend\src\routes\index.ts L:111<br>backend\src\routes\plan109.routes.ts L:463 |
...
| GET | `/interaction/:uid/data` | `identity-provider\src\app.ts L:61` | `authController.getInteractionData` | `-` | - |
...
- **Total Endpoints:** 14
- **Endpoints with Usages:** 1
- **Total Usage References:** 1
- **Unused Endpoints:** 13
