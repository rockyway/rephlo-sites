...
**Generated:** 2025-11-12T21:48:33.960Z
**Format:** Simple
**Include Tests:** No
...
|--------|----------|------|---------|-----------------|---------------|------------|--------|
| GET | `/metrics` | `backend\src\routes\admin.routes.ts L:63` | `adminController.getMetrics` | `{ status: "success", data: T }` | `500: error_response` | `-` | frontend\src\services\api.ts L:260<br>backend\coverage\lcov-report\src\routes\index.ts.html L:610<br>backend\coverage\src\routes\index.ts.html L:610<br>backend\src\routes\index.ts L:108 |
