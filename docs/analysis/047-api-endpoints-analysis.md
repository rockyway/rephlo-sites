...
**Generated:** 2025-11-12T21:34:43.116Z
**Format:** Simple
**Include Tests:** No
...
| GET | `/interaction/:uid` | `identity-provider\src\app.ts L:57` | `authController.interaction` | `-` | identity-provider\src\views\consent.html L:294<br>identity-provider\src\views\login.html L:233 |
| GET | `/interaction/:uid/abort` | `identity-provider\src\app.ts L:60` | `authController.abort` | `-` | - |
| POST | `/interaction/:uid/consent` | `identity-provider\src\app.ts L:59` | `authController.consent` | `-` | - |
...
| POST | `/interaction/:uid/login` | `identity-provider\src\app.ts L:58` | `authController.login` | `-` | - |
